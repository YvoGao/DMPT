...
We used [PENGI](https://github.com/microsoft/Pengi) for model instantiation and borrowed a part of code from [COOP/COCOOP](https://github.com/KaiyangZhou/CoOp) and [PALM](https://github.com/asif-hanif/PALM) to implement baselines. We thank the respective authors for releasing the code.
